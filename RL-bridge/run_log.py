...
def get_joint_action_eval(game, multi_part_agent_ids, policy_list, actions_spaces, all_observes):
    # print("multi_part_agent_ids: ", multi_part_agent_ids)  # [range(0, 1), range(1, 2), range(2, 3), range(3, 4)]
    # print("policy_list: ", policy_list)                    # ['random', 'random', 'random', 'random']
    # print("actions_spaces: ", actions_spaces)              # [[[Discrete(38)]], [[Discrete(38)]], [[Discrete(38)]], [[Discrete(38)]]]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, default='chessandcard-mahjong_v3', help='fourplayers_nolimit_texas_holdem/'
                                                                                            'chessandcard-mahjong_v3/'
                                                                                            'bridge')
    parser.add_argument('--render', action='store_true', help='if render the env')
    parser.add_argument("--my_ai", default="SLv1", help="rl/random")
    parser.add_argument("--opponent", default="SLv1", help="rl/random")
    ...
    # print("multi_part_agent_ids: ", multi_part_agent_ids)  # [range(0, 1), range(1, 2), range(2, 3), range(3, 4)]
    # print("actions_space: ", actions_space)                # [[[Discrete(38)]], [[Discrete(38)]], [[Discrete(38)]], [[Discrete(38)]]]
    run_game(game, env_type, multi_part_agent_ids, actions_space, policy_list, render_mode, if_render=False)
